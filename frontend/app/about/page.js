        ...
        <section className="grid grid-cols-1 lg:grid-cols-2 gap-8 items-center mb-12">
          <div>
            ...
            <div className="space-y-3">
              <p className="flex items-start gap-3"><span className="inline-block bg-indigo-600 text-white px-2 py-1 rounded mr-2">OK</span> Personalized job recommendations</p>
              <p className="flex items-start gap-3"><span className="inline-block bg-indigo-600 text-white px-2 py-1 rounded mr-2">OK</span> One-click applications and resume parsing</p>
              <p className="flex items-start gap-3"><span className="inline-block bg-indigo-600 text-white px-2 py-1 rounded mr-2">OK</span> Secure employer tools and analytics</p>
            </div>
          </div>
