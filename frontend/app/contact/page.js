        ...
        <div className="max-w-6xl mx-auto grid grid-cols-1 lg:grid-cols-2 gap-10 items-start">
          ...
          <div className="order-2 lg:order-1">
            <div className="bg-white border rounded-xl p-8 shadow-lg">
              <h1 className="text-3xl md:text-4xl font-extrabold text-indigo-800 mb-2">
                Let&apos;s talk
              </h1>
              ...
              <form onSubmit={handleSubmit} className="space-y-5">
                <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                  <div>
                    ...
                    <input
                      ...
                      required
                      className="mt-1 block w-full border border-gray-200 rounded-md px-3 py-2 focus:outline-none focus-visible:ring-2 focus-visible:ring-indigo-200"
                    />
                  </div>
                ...
                <div className="flex items-center gap-4">
                  <button
                    type="submit"
                    className="inline-flex items-center gap-3 bg-indigo-700 text-white px-5 py-2 rounded-md hover:bg-indigo-800 focus:outline-none focus-visible:ring-2 focus-visible:ring-indigo-300"
                  >
            ...
            <div className="bg-gradient-to-b from-indigo-50 to-white border rounded-xl p-6 shadow-sm">
              ...
              <p className="text-sm text-gray-700">
                ...
                <a
                  ...
                  href="mailto:support@jobportal.example"
                >
